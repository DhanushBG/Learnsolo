		...
		<!-- Nav -->
			<nav id="nav" class="skel-panels-fixed">
				<ul>
					...
					<li class="current_page_item"><a href="signin.php">Sign-in</a></li>
						...
						<div class="9u skel-cell-important">
							<div class="content content-left">
												<!-- Contact Form -->
														...
														<h2 class="major"><span>SIGN-in</span></h2>
													<section class="footer-one">
														<form id="form" name="first" method="post" action="logincheckadmin.php" onsubmit="return validate()">
															<div>
																<div align="center" >
																	<div class="4u">
																	<input type="text" class="text" name="txtuid" id="txtuid" placeholder="user-id" />
																	</div><br/>
																	<div class="4u">
						...
						<div class="3u">
							<div class="sidebar">
								...
								<!-- Sidebar -->
									...
									<!-- Recent Posts -->
										<section>
											<h2 class="major"><span>No Account Yet?</span></h2>
											<ul class="style2">
											...
											<a href="signup.php" class="button button-alt">SIGN UP</a>
										</section>
									<!-- /Recent Posts -->

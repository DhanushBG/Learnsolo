                ...
                <div class="container">
                    <div class="row">
                        <div class="12u skel-cell-important" id="content">
                            ...
                            <header>
                                    <h2><a><span class="byline">Welcome to the Android Quiz #1</span></a></h2>
                                    </header>
    <?php
...
<?php
    ...
    $loadedQuestions = readQuestions("android.txt");
...
if (isset($_POST['submitquiz'])) {
    ...
    $answerKey = readAnswerKey("androidkey.txt");
    ...
    $score+=$percentage;
    $score/=$attempt_no;
    $result1=mysql_query("UPDATE user_score1 set attempt='$attempt_no', score1='$score', date1='$dat1' where login='$uid' AND subject='android'")or die("could not update");
